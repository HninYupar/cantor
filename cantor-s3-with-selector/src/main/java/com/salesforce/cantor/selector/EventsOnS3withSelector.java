...
public class EventsOnS3withSelector extends AbstractBaseS3Namespaceable implements Events {
    private static final Logger logger = LoggerFactory.getLogger(EventsOnS3withSelector.class);
