...
public class ObjectsOnS3withSelector extends AbstractBaseS3Namespaceable implements StreamingObjects {
    private static final Logger logger = LoggerFactory.getLogger(ObjectsOnS3withSelector.class);

    // cantor-objects-<namespace>/<startTimestamp>-<endTimestamp>
    private static final String objectKeyPrefix = "cantor-objects";

    public ObjectsOnS3withSelector(final AmazonS3 s3Client, final String bucketName) throws IOException {
